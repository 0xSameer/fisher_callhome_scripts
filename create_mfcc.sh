...
echo "apply cmvn"
nice apply-cmvn --norm-vars=true --utt2spk=ark:data/train/utt2spk scp:data/train/cmvn.scp scp:data/train/feats.scp ark:- | add-deltas ark:- ark:- | copy-feats ark:- ark,t:train_mfcc.ark
nice apply-cmvn --norm-vars=true --utt2spk=ark:data/dev/utt2spk scp:data/dev/cmvn.scp scp:data/dev/feats.scp ark:- | add-deltas ark:- ark:- | copy-feats ark:- ark,t:dev_mfcc.ark
